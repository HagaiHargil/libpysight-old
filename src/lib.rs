...
//    #[pyfn(m, "read_binary_lst")]
//    fn py_read_lst(py: Python, file_path: String, start_of_data_pos: u64, range: u64, timpatch: String,
//             channel_map: Vec<u8>) -> PyResult<Vec<_>> {
//         let result = py.allow_threads(move || analyze_lst(&file_path, start_of_data_pos, range, &timpatch, channel_map));
//         Ok(result)
//     }
//     Ok(())
...
pub fn analyze_lst(fname: &str, start_of_data: usize, range: u64,
    ...
    let chan_map = create_channel_vec(timepatch, channel_map, start_of_data, data_size);
